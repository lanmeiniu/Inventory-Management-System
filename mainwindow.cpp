...
void MainWindow::getDataFromMysql()
{
    if(!getDataFromMysqlDialog)
    {
        ...
        connect(getDataFromMysqlDialog, SIGNAL(getAlldata()),
                infomationManager, SLOT(getAllDataFromMysql()));
...
void MainWindow::about()
{
    QMessageBox::about(this, tr("About Spreadsheet"),
            tr("<h2>Spreadsheet 1.0</h2>"
               ...
               "<p>4.When the fixed assets account, please click [sweep work piece]"));
}
...
void MainWindow::createActions()
{
    ...
    selectRowAction->setIcon(QIcon(":/images/row.png"));
    ...
    selectColumnAction->setIcon(QIcon(":images/column.png"));
    ...
    recalculateAction->setIcon(QIcon(":images/recalculate.png"));
    ...
    setDatabaseAndTableAction->setShortcut(tr("F1"));
    setDatabaseAndTableAction->setIcon(QIcon(":/images/database.png"));
    ...
    getDataFromMysqlDialogAction->setShortcut(tr("F2"));
    getDataFromMysqlDialogAction->setIcon(QIcon(":images/getdata.png"));
    ...
    generateQRcodeDialogAction->setIcon(QIcon(":/images/qrcode.png"));
    generateQRcodeDialogAction->setShortcut(tr("F3"));
    ...
    scanWorkPieceAction->setIcon(QIcon(":/images/scan.png"));
    scanWorkPieceAction->setShortcut(tr("F4"));
...
void MainWindow::createToolBars()
{
    ...
    editToolBar->addAction(setDatabaseAndTableAction);
    editToolBar->addAction(getDataFromMysqlDialogAction);
    editToolBar->addAction(scanWorkPieceAction);
    editToolBar->addAction(generateQRcodeDialogAction);
